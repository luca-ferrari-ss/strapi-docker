...
export interface ApiAgendaAgenda extends Schema.CollectionType {
  ...
  attributes: {
    ...
    blocks: Attribute.DynamicZone<['blocks.spacer']> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiFooterFooter extends Schema.SingleType {
  ...
  attributes: {
    logo: Attribute.Component<'elements.image-link'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiHeaderHeader extends Schema.SingleType {
  ...
  attributes: {
    logoTransparent: Attribute.Component<'elements.image-link'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    linksLeft: Attribute.DynamicZone<
      ['elements.link', 'elements.dropdown-link']
    > &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    linksRight: Attribute.DynamicZone<
      ['elements.link', 'elements.dropdown-link']
    > &
      Attribute.SetPluginOptions<{
        i18n: {
